...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(MapsActivity.this, "Check your Location is ON", Toast.LENGTH_SHORT).show();
        ...
        btnMap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch(message){
                    ...
                    case "atm":
                        mMap.clear();
                        url = getUrl(latitude, longitude, Blood_Bank);
                        DataTransfer = new Object[2];
                        DataTransfer[0] = mMap;
                        DataTransfer[1] = url;
                        Log.d("onClick", url);
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace) {
        ...
        googlePlacesUrl.append("&key=" + "AIzaSyA5gTyeWWc1hQIRxFOg7fXlSK931f_hpYU");
    ...
    public void onConnectionSuspended(int i) {
        //NotificationCompat.MessagingStyle.Message("SUspended")
